 ...
 * @param {Object} preferences - Route preferences
 * @returns {Object} Route information
 */
exports.findOptimalPath = (source, destination, preferences = {}) => {
  ...
  // Estimate travel time based on preferences (in seconds)
  let avgSpeed = 50; // Default 50 km/h

  if (preferences.fastestRoute) {
    avgSpeed = 60; // Faster routes
  } else if (preferences.scenic) {
    avgSpeed = 40; // Slower for scenic routes
  }
